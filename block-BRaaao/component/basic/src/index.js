...
import Article ,{Articles} from "./component/Article";
...
let data= [{
  ...
  },
  {
    ...
    urlToImage:
      'https://images.livemint.com/img/2022/08/11/600x338/vistadome1_1660180990346_1660181004608_1660181004608.jpg',
...
reactDom.render(<Hero/> ,section);
reactDom.render(<Articles data={data}   /> , article)
